...
class DQNAgent:
    """A simple Deep Q-Network Agent with epsilon decay."""
    ...
    def __init__(self,
                 ...
                 decay_factor=0.995,  # Add decay factor for epsilon
                 verbose=True,
                 **kwargs):
        ...
        self.epsilon = 1.0  # Start with epsilon = 1.0
...
def run_dqn_agent(env,seed,gamma,verbose=True):
    agent=DQNAgent(env,seed,gamma,verbose)
    return agent
